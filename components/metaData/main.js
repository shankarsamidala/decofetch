const metaData = (value) => {
    ...
    if (value === "living-room") {
        content.title =
            "Luxury Living Room Furniture | Sofa, Chairs, Tables, TV Stands";
        content.desc =
            "Shop the luxury living room furniture from the Decofetch store, including sofas, chairs, coffee tables, TV stands, benches, sofa beds, ottomans, and stools. Shop today!";
        content.keys = "Luxury Living Room Furniture";
    }
    ...
    if (value === "sofa-beds") {
        content.title = "Buy Luxury Sofa Beds| Decofetch";
        content.desc =
    ...
    if (value === "coffee-tables") {
        content.title =
            "Luxury Coffee Tables | Luxury Wooden Coffee Tables | Decofetch";
        content.desc =
            "Buy Luxury Coffee Table online at Decofetch. We have a range of Designer Coffee Tables that are in various shapes, sizes, colors, and features. Our Luxury Wooden Coffee Table is one of the best options for you.";
        content.keys =
            "Designer Coffee Tables, Luxury Wooden Coffee Table, Luxury Coffee Table";
    }

    if (value === "end-&-side-tables") {
        content.title = "Luxury Side Tables | Designer Side Table | Decofetch";
        content.desc =
            " Luxury side tables are a great addition to any home. They are perfect for displaying decorative items and holding drinks or snacks. Buy Designer Side Table now!";
        content.keys = "Luxury Side Tables, Designer Side Table";
    }

    if (value === "bedside-tables") {
        content.title = "Luxury Designer Bedside Table | Decofetch";
        content.desc =
            " Decofetch offers Designer Bedside Tables that will fit your space and needs. These elegant and stylish pieces of furniture will elevate the look of your room and add a touch of luxury to any space.";
    ...
    if (value === "beds") {
        content.title =
            "Luxury Designer Beds | Bespoke Luxury Beds King Size | Decofetch";
        content.desc =
    ...
    if (value === "dining-room") {
        content.title =
            "Luxury Dining Sets | Dining Room Tables, Chairs, and Barstools | Decofetch";
        content.desc =
            "Create the ultimate dining experience with Decofetch's Luxury Dining Sets. Our collection of dining room tables, chairs, and barstools is the perfect combination of style and comfort!";
        content.keys = "";
    }
    ...
    if (value === "sideboards") {
        ...
        content.desc =
            "Discover the perfect luxury and designer sideboard furniture from the Decofetch store that is crafted from high-quality materials and designed to make a statement in any space. Shop online now!";
        content.keys = "Luxury Sideboard, Designer Sideboard";
    }

    if (value === "benches") {
        content.title = "Luxury Bedroom Bench | Decofetch";
        content.desc =
            " Add a touch of luxury to your living room with Decofetch's collection of high-end luxury Bedroom Benches. Browse our stylish options to elevate your space. Shop now!";
        content.keys = "Luxury Bedroom Bench";
    }
    if (value === "chandeliers") {
        content.title = "Luxury Chandeliers | Designer Chandeliers | Decofetch";
        content.desc =
            "Shop Decofetch's collection of luxury chandeliers for a touch of elegance in your home. Our designer chandeliers elevate any room and provide a stunning focal point. ";
        content.keys = "luxury chandelier";
    }
    if (value === "bedroom") {
        content.title =
            "Luxury Bedroom Furniture | Beds, Beside Tables, Mattresses | Decofetch";
        content.desc =
            "Decofetch offers premium luxury bedroom furniture to enhance your sleeping quarters. Browse our elegant and stylish bedroom furniture crafted from high-quality materials!";
        content.keys = "luxury bedroom furniture";
    }
    if (value === "desks") {
        content.title = "Luxury Desk for Your Home Office | Decofetch";
        content.desc =
            "Want to set up your home office with Luxury Desk and tables Decofetch is the best place where you get what you need. Let’s give a stunning royal look to your workplace.";
        content.keys = "Luxury Desk";
    }
    if (value === "home-office") {
        content.title = "Designer Home Office Furniture | Decofetch";
        content.desc =
            "Let’s set up a versatile office in your home with the Designer Home Office Furniture. Our selected collection of desks and chairs will give a royal look to your workplace.";
        content.keys = "Designer Home Office Furniture";
    }
